<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($enteredOTP == $_SESSION['otp']) {
            ...
            $insertQuery = "INSERT INTO current_admin_sessions (session_id, admin_id, ip, mac) VALUES (?, ?, ?, ?)";
            $insertStmt = mysqli_prepare($con, $insertQuery);
            mysqli_stmt_bind_param($insertStmt, "ssss", session_id(), $adminId, $ipAddress, $macAddress);
    ...
    <div class="container d-flex justify-content-center align-items-center vh-100">
        <div class="card">
            <div class="card-body text-center" style="padding: 50px;">
                <h1 class="card-title">Admin-Login OTP has been sent via E-mail</h1><br>
